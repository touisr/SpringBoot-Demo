...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://120.77.180.207:3306/user-service";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Qr@2017";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

    // Oracle
/*    private static final String JDBC_URL = "jdbc:oracle:thin:@112.74.212.112:1521/orcl";
    private static final String JDBC_USERNAME = "cbec_dev";
    private static final String JDBC_PASSWORD = "baibei_2016";
    ...
    public static void main(String[] args) {
        //genCode("t_agent");
        //genCodeByCustomModelName("t_agent", "Agent");
        //genCodeByCustomModelName("t_agent_legal_person", "AgentLegalPerson");
        //genCodeByCustomModelName("t_agent_ref", "AgentRef");
        genCodeByCustomModelName("t_customer", "Customer");
        //genCodeByCustomModelName("t_sms_code", "SmsCode");
    }
